...
namespace UnityEngine.EventSystems
{
    ...
    /// </summary>
    public class OVRInputModuleController : PointerInputModule
    {
        ...
        protected OVRInputModuleController()
        {}
...
#region PointerEventData pool
        ...
        virtual protected MouseState GetGazePointerData()
        {
            ...
            _vREyeRaycaster.GetStartAndEndPoint(out worldStartPoint, out worldEndPoint);
            Ray ray = _vREyeRaycaster.CreateRayFromControllerOrCamera(worldStartPoint, worldEndPoint);
            leftData.worldSpaceRay = ray;
