...
namespace VRStandardAssets.Utils
{
    ...
    public class VREyeRaycaster : MonoBehaviour
    {
        ...
        public void GetStartAndEndPoint(out Vector3 worldStartPoint, out Vector3 worldEndPoint) {
        ...
        public Ray CreateRayFromControllerOrCamera(Vector3 worldStartPoint, Vector3 worldEndPoint)
        {
        ...
        private void EyeRaycast()
        {
            ...
            // if we have the controller connected we need to setup start and end point from it
            Vector3 worldStartPoint = Vector3.zero;
            Vector3 worldEndPoint = Vector3.zero;
            GetStartAndEndPoint(out worldStartPoint, out worldEndPoint);
            Ray ray = CreateRayFromControllerOrCamera(worldStartPoint, worldEndPoint);
